...
2.  Enter **BLUEPRINT_DT264_US_XX** (replace *XX* with your seat number, for example **BLUEPRINT_DT264_US_01**) as the **Name**, and select the UDP **Analysis** created in the first exercise. Afterwards, choose **Create**.<br><br>
